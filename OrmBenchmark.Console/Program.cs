...
namespace OrmBenchmark.ConsoleUI
{
    class Program
    {
        ...
        {
            string connStringName = ConfigurationManager.AppSettings["DefaultConnectionStringName"];
            ...
            string ver = AppDomain.CurrentDomain.SetupInformation.TargetFrameworkName;//Environment.Version
